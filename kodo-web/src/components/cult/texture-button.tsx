...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      lima:
        "w-full border-[1px] border-black/20 bg-gradient-to-b from-[#d4f58a] to-[#7fb800] p-[1px] transition duration-300 ease-in-out",
      accent:
  ...
  "text-muted-foreground flex h-full w-full items-center justify-center",
  {
    variants: {
      variant: {
        ...
        lima:
          "gap-2 bg-gradient-to-b from-[#bdf04f] to-[#9ad61f] text-sm text-[#141414] transition duration-300 ease-in-out hover:from-[#c8f566] hover:to-[#a5e02c] active:from-[#9ad61f] active:to-[#9ad61f]",
        accent:
